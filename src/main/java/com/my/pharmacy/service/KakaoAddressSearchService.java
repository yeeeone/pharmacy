...
public class KakaoAddressSearchService {
    ...
    //uri 만들기: https://dapi.kakao.com/v2/local/search/address.json?query=인사동길 12
...
//        System.out.println("${kakao.rest.api.key}: " + kakaoRestApiKey);
        ...
        UriComponentsBuilder uriBuilder = UriComponentsBuilder.fromHttpUrl(KAKAO_LOCAL_URL);
        uriBuilder.queryParam("query", address);

        // 해석 불가능한 문자를 UTF-8 인코딩
